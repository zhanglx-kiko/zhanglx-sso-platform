 ...
 */
    private static BusinessException translateAliyun(SmsSendResult result) {
        ...
        return switch (providerCode) {
            ...
            case "BUSINESS_LIMIT_CONTROL" -> BusinessException.badGateway("technical.sms.provider.daily.limit.exceeded");
            ...
            case "ACCESS_DENIED", "NO_PERMISSION", "NO_AUTHORITY" -> BusinessException.internalError("technical.sms.aliyun.access.denied");
 ...
 */
    private static BusinessException translateSmsChinese(SmsSendResult result) {
        ...
        return switch (providerCode) {
            ...
            case "-14", "-42", "-51", "-52", "TEMPLATE_NOT_CONFIGURED" -> BusinessException.internalError("technical.sms.template.not.configured");
